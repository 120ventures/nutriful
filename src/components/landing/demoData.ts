...
/** Language-neutral keys - the visible label comes from mealLabels. */
...
export const planGoals: PlanGoal[] = [
  {
    ...
    blocks: [
      { id: "u1", slot: "breakfast", icon: "🥣", text: "Porridge mit Beeren", ingredients: ["Haferflocken", "Milch", "Beeren", "Zimt"], kcal: 380, highlights: ["Ballaststoffe", "Calcium"], diets: VEGGIE_DAIRY },
      { id: "u10", slot: "breakfast", icon: "🌾", text: "Haferdrink-Porridge mit Apfel", ingredients: ["Haferflocken", "Haferdrink", "Apfel", "Zimt"], kcal: 350, highlights: ["Ballaststoffe", "Magnesium"], diets: ALL },
      { id: "u2", slot: "breakfast", icon: "🍳", text: "Rührei mit Tomaten", ingredients: ["Eier", "Tomaten", "Olivenöl", "Schnittlauch"], kcal: 320, highlights: ["Eiweiß", "Vitamin B12"], diets: VEGGIE_LF },
      { id: "u9", slot: "breakfast", icon: "🥓", text: "Vollkornbrot mit Schinken", ingredients: ["Vollkornbrot", "Schinken", "Butter", "Gurke"], kcal: 340, highlights: ["Eiweiß", "Ballaststoffe"], diets: NONE },
      { id: "u3", slot: "lunch", icon: "🍚", text: "Reis mit Hühnchen und Gemüse", ingredients: ["Reis", "Hühnerbrust", "Karotten", "Brokkoli"], kcal: 560, highlights: ["Eiweiß", "Vitamin C"], diets: MEAT },
      { id: "u4", slot: "lunch", icon: "🥗", text: "Großer Salat mit Ei", ingredients: ["Blattsalat", "Eier", "Tomaten", "Olivenöl"], kcal: 420, highlights: ["Eiweiß", "Folsäure"], diets: VEGGIE_LF },
      { id: "u11", slot: "lunch", icon: "🫘", text: "Linsensalat mit Ofengemüse", ingredients: ["Linsen", "Zucchini", "Paprika", "Olivenöl"], kcal: 480, highlights: ["Ballaststoffe", "Eisen"], diets: ALL },
      { id: "u12", slot: "lunch", icon: "🥙", text: "Falafel-Bowl mit Hummus", ingredients: ["Kichererbsen", "Bulgur", "Gurke", "Tahin"], kcal: 540, highlights: ["Ballaststoffe", "Eisen"], diets: ALL },
      { id: "u5", slot: "dinner", icon: "🐟", text: "Fisch mit Kartoffeln", ingredients: ["Kabeljau", "Kartoffeln", "Zitrone", "Petersilie"], kcal: 460, highlights: ["Eiweiß", "Jod"], diets: MEAT },
      { id: "u6", slot: "dinner", icon: "🍲", text: "Gemüseeintopf", ingredients: ["Karotten", "Sellerie", "Kartoffeln", "Lauch"], kcal: 320, highlights: ["Beta-Carotin", "Kalium"], diets: ALL },
      { id: "u13", slot: "dinner", icon: "🎃", text: "Ofenkürbis mit Feta", ingredients: ["Kürbis", "Feta", "Kürbiskerne", "Olivenöl"], kcal: 430, highlights: ["Calcium", "Beta-Carotin"], diets: VEGGIE_DAIRY },
      { id: "u14", slot: "dinner", icon: "🍜", text: "Gemüsecurry mit Reis", ingredients: ["Reis", "Kokosmilch", "Brokkoli", "Karotten"], kcal: 520, highlights: ["Vitamin C", "Ballaststoffe"], diets: ALL },
  ...
  },
  {
    ...
    blocks: [
      { id: "g1", slot: "breakfast", icon: "🍳", text: "Eier mit Vollkornbrot", ingredients: ["Eier", "Vollkornbrot", "Tomaten"], kcal: 330, highlights: ["Eiweiß", "Vitamin B12"], diets: VEGGIE_LF },
      { id: "g2", slot: "breakfast", icon: "🥛", text: "Topfen mit Beeren", ingredients: ["Topfen", "Beeren", "Leinsamen"], kcal: 260, highlights: ["Eiweiß", "Calcium"], diets: VEGGIE_DAIRY },
      { id: "g9", slot: "breakfast", icon: "🥣", text: "Haferbrei mit Zimt", ingredients: ["Haferflocken", "Wasser", "Zimt", "Apfel"], kcal: 300, highlights: ["Ballaststoffe", "Magnesium"], diets: ALL },
      { id: "g11", slot: "breakfast", icon: "🌱", text: "Sojajoghurt mit Chiasamen", ingredients: ["Sojajoghurt", "Chiasamen", "Heidelbeeren"], kcal: 280, highlights: ["Eiweiß", "Ballaststoffe"], diets: ALL },
      { id: "g3", slot: "lunch", icon: "🥗", text: "Salat mit Hühnerbrust", ingredients: ["Blattsalat", "Hühnerbrust", "Gurke", "Essig-Öl-Dressing"], kcal: 420, highlights: ["Eiweiß", "Folsäure"], diets: MEAT },
      { id: "g4", slot: "lunch", icon: "🍲", text: "Gemüsesuppe mit Linsen", ingredients: ["Linsen", "Karotten", "Sellerie", "Zwiebel"], kcal: 380, highlights: ["Ballaststoffe", "Eisen"], diets: ALL },
      { id: "g12", slot: "lunch", icon: "🐟", text: "Thunfischsalat mit Bohnen", ingredients: ["Thunfisch", "Weiße Bohnen", "Zwiebel", "Petersilie"], kcal: 440, highlights: ["Eiweiß", "Eisen"], diets: MEAT },
      { id: "g13", slot: "lunch", icon: "🥦", text: "Brokkoli-Quinoa-Bowl", ingredients: ["Quinoa", "Brokkoli", "Kichererbsen", "Zitrone"], kcal: 460, highlights: ["Eiweiß", "Vitamin C"], diets: ALL },
      { id: "g5", slot: "dinner", icon: "🐟", text: "Lachs mit Brokkoli", ingredients: ["Lachs", "Brokkoli", "Zitrone"], kcal: 480, highlights: ["Omega-3", "Vitamin D"], diets: MEAT },
      { id: "g6", slot: "dinner", icon: "🥒", text: "Bunter Teller mit Ei", ingredients: ["Eier", "Paprika", "Gurke", "Vollkornbrot"], kcal: 390, highlights: ["Eiweiß", "Vitamin C"], diets: VEGGIE_LF },
      { id: "g10", slot: "dinner", icon: "🍠", text: "Ofengemüse mit Kichererbsen", ingredients: ["Kichererbsen", "Karotten", "Zucchini", "Olivenöl"], kcal: 420, highlights: ["Ballaststoffe", "Beta-Carotin"], diets: ALL },
      { id: "g14", slot: "dinner", icon: "🍜", text: "Zucchininudeln mit Tofu", ingredients: ["Zucchini", "Tofu", "Tomaten", "Basilikum"], kcal: 350, highlights: ["Eiweiß", "Calcium"], diets: ALL },
  ...
  },
  {
    ...
    blocks: [
      { id: "s1", slot: "breakfast", icon: "🥣", text: "Haferflocken mit Whey", ingredients: ["Haferflocken", "Whey-Protein", "Milch", "Banane"], kcal: 520, highlights: ["Eiweiß", "Kalium"], diets: VEGGIE_DAIRY },
      { id: "s2", slot: "breakfast", icon: "🍳", text: "Eier mit Vollkorntoast", ingredients: ["Eier", "Vollkorntoast", "Avocado"], kcal: 480, highlights: ["Eiweiß", "Kalium"], diets: VEGGIE_LF },
      { id: "s9", slot: "breakfast", icon: "🌱", text: "Sojajoghurt mit Haferflocken", ingredients: ["Sojajoghurt", "Haferflocken", "Beeren"], kcal: 400, highlights: ["Eiweiß", "Ballaststoffe"], diets: ALL },
      { id: "s13", slot: "breakfast", icon: "🥞", text: "Haferpfannkuchen mit Topfen", ingredients: ["Haferflocken", "Eier", "Topfen", "Honig"], kcal: 540, highlights: ["Eiweiß", "Calcium"], diets: VEGGIE_DAIRY },
      { id: "s3", slot: "lunch", icon: "🍗", text: "Hühnchen, Reis, Brokkoli", ingredients: ["Hühnerbrust", "Reis", "Brokkoli"], kcal: 620, highlights: ["Eiweiß", "Vitamin C"], diets: MEAT },
      { id: "s4", slot: "lunch", icon: "🍝", text: "Pasta mit Putenragout", ingredients: ["Vollkornpasta", "Putenfleisch", "Tomaten", "Zwiebel"], kcal: 650, highlights: ["Eiweiß", "Ballaststoffe"], diets: MEAT },
      { id: "s10", slot: "lunch", icon: "🫘", text: "Linsen-Bolognese mit Vollkornpasta", ingredients: ["Rote Linsen", "Vollkornpasta", "Tomaten", "Karotten"], kcal: 600, highlights: ["Ballaststoffe", "Eisen"], diets: ALL },
      { id: "s14", slot: "lunch", icon: "🌯", text: "Hühnchen-Wrap mit Gemüse", ingredients: ["Vollkornwrap", "Hühnerbrust", "Paprika", "Hummus"], kcal: 580, highlights: ["Eiweiß", "Vitamin C"], diets: MEAT },
      { id: "s5", slot: "dinner", icon: "🐟", text: "Lachs mit Süßkartoffel", ingredients: ["Lachs", "Süßkartoffel", "Spinat"], kcal: 610, highlights: ["Omega-3", "Beta-Carotin"], diets: MEAT },
      { id: "s6", slot: "dinner", icon: "🍚", text: "Reis mit Rindfleisch", ingredients: ["Reis", "Rindfleisch", "Paprika"], kcal: 640, highlights: ["Eiweiß", "Eisen"], diets: MEAT },
      { id: "s11", slot: "dinner", icon: "🍜", text: "Tofu-Pfanne mit Reis", ingredients: ["Tofu", "Reis", "Brokkoli", "Sojasauce"], kcal: 550, highlights: ["Eiweiß", "Calcium"], diets: ALL },
      { id: "s15", slot: "dinner", icon: "🥘", text: "Kichererbsen-Curry mit Reis", ingredients: ["Kichererbsen", "Reis", "Kokosmilch", "Spinat"], kcal: 590, highlights: ["Ballaststoffe", "Eisen"], diets: ALL },
  ...
  },
  {
    ...
    blocks: [
      { id: "i1", slot: "breakfast", icon: "🍚", text: "Reisbrei mit Banane", ingredients: ["Reis", "Wasser", "Banane"], kcal: 340, highlights: ["Kalium", "leicht verdaulich"], diets: ALL },
      { id: "i2", slot: "breakfast", icon: "🥣", text: "Hirsebrei", ingredients: ["Hirse", "Wasser", "Zimt"], kcal: 320, highlights: ["Magnesium", "Eisen"], diets: ALL },
      { id: "i10", slot: "breakfast", icon: "🍐", text: "Buchweizenbrei mit Birne", ingredients: ["Buchweizen", "Wasser", "Birne"], kcal: 330, highlights: ["Ballaststoffe", "Magnesium"], diets: ALL },
      { id: "i11", slot: "breakfast", icon: "🥔", text: "Kartoffelpuffer mit Apfelmus", ingredients: ["Kartoffeln", "Apfelmus", "Olivenöl"], kcal: 360, highlights: ["Kalium", "Vitamin C"], diets: ALL },
      { id: "i3", slot: "lunch", icon: "🍗", text: "Hühnchen mit Reis", ingredients: ["Hühnerbrust", "Reis", "Karotten"], kcal: 520, highlights: ["Eiweiß", "Beta-Carotin"], diets: MEAT },
      { id: "i9", slot: "lunch", icon: "🥔", text: "Kartoffel-Gemüse-Pfanne", ingredients: ["Kartoffeln", "Karotten", "Zucchini", "Olivenöl"], kcal: 430, highlights: ["Kalium", "Beta-Carotin"], diets: ALL },
      { id: "i12", slot: "lunch", icon: "🍜", text: "Reisnudeln mit Gemüse", ingredients: ["Reisnudeln", "Zucchini", "Karotten", "Sesamöl"], kcal: 470, highlights: ["Beta-Carotin", "leicht verdaulich"], diets: ALL },
      { id: "i13", slot: "lunch", icon: "🍗", text: "Pute mit Kartoffelpüree", ingredients: ["Putenfleisch", "Kartoffeln", "Haferdrink", "Petersilie"], kcal: 500, highlights: ["Eiweiß", "Kalium"], diets: MEAT },
      { id: "i4", slot: "dinner", icon: "🐟", text: "Fisch mit Kartoffeln", ingredients: ["Kabeljau", "Kartoffeln", "Petersilie"], kcal: 440, highlights: ["Eiweiß", "Jod"], diets: MEAT },
      { id: "i5", slot: "dinner", icon: "🍲", text: "Gemüseeintopf", ingredients: ["Karotten", "Kartoffeln", "Sellerie"], kcal: 310, highlights: ["Beta-Carotin", "Kalium"], diets: ALL },
      { id: "i6", slot: "dinner", icon: "🥕", text: "Gemüsepfanne", ingredients: ["Zucchini", "Karotten", "Paprika", "Olivenöl"], kcal: 290, highlights: ["Vitamin C", "Beta-Carotin"], diets: ALL },
      { id: "i14", slot: "dinner", icon: "🎃", text: "Kürbissuppe mit Reis", ingredients: ["Kürbis", "Reis", "Ingwer", "Olivenöl"], kcal: 360, highlights: ["Beta-Carotin", "Kalium"], diets: ALL },
